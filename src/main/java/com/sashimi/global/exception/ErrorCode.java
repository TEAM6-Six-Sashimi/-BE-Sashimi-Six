...
public enum ErrorCode {
    ...
    PAYMENT_ORDER_NOT_FOUND(404, "PAYMENT_001", "주문 정보를 찾을 수 없습니다."),
    ...
    PAYMENT_INVALID_STATUS(400, "PAYMENT_005", "현재 결제를 처리할 수 없습니다."),
    ...
    PAYMENT_COURSE_ID_REQUIRED(400, "PAYMENT_010", "단일 강의 결제에는 강의 정보가 필요합니다."),
    PAYMENT_CART_COURSE_ID_NOT_ALLOWED(400, "PAYMENT_011", "장바구니 결제 요청 정보가 올바르지 않습니다."),
    PAYMENT_SUBSCRIPTION_PLAN_REQUIRED(400, "PAYMENT_012", "구독권 결제에는 구독 플랜 정보가 필요합니다."),
    PAYMENT_PLAN_NOT_ALLOWED(400, "PAYMENT_013", "결제 요청 정보가 올바르지 않습니다."),
    PAYMENT_SUBSCRIPTION_COURSE_ID_NOT_ALLOWED(400, "PAYMENT_014", "구독권 결제 요청 정보가 올바르지 않습니다."),
    PAYMENT_IDEMPOTENCY_KEY_INVALID(400, "PAYMENT_015", "결제 요청이 정상적으로 생성되지 않았습니다. 다시 시도해 주세요."),
    PAYMENT_IDEMPOTENCY_KEY_CONFLICT(409, "PAYMENT_016", "이미 다른 결제 요청으로 처리된 요청입니다. 결제 화면에서 다시 시도해 주세요."),
    PAYMENT_IDEMPOTENCY_PROCESSING(409, "PAYMENT_017", "결제가 처리 중입니다. 잠시 후 다시 확인해 주세요."),
    PAYMENT_IDEMPOTENCY_RESULT_INVALID(500, "PAYMENT_018", "결제 결과를 확인하는 중 문제가 발생했습니다. 잠시 후 다시 시도해 주세요."),
    PAYMENT_IDEMPOTENCY_FAILED(409, "PAYMENT_019", "이전 결제 요청이 실패했습니다. 결제 화면에서 다시 시도해 주세요."),
    PAYMENT_INVALID_AMOUNT(400, "PAYMENT_020", "결제 금액은 0보다 커야 합니다."),
    PAYMENT_INVALID_STATE_TRANSITION(409, "PAYMENT_021", "허용되지 않은 결제 상태 변경입니다."),

    ORDER_INVALID_AMOUNT(400, "ORDER_001", "주문 금액 정보가 올바르지 않습니다."),
    ORDER_INVALID_STATE_TRANSITION(409, "ORDER_002", "허용되지 않은 주문 상태 변경입니다."),
    ORDER_ITEM_INVALID(400, "ORDER_003", "주문 항목 정보가 올바르지 않습니다."),
    ...
    CREDIT_EXTERNAL_PAYMENT_RESPONSE_MISMATCH(502, "CREDIT_010", "결제 승인 정보가 요청 정보와 일치하지 않습니다."),
    CREDIT_CHARGE_RESULT_INCONSISTENT(500, "CREDIT_011", "크레딧 충전 결과를 확인하는 중 문제가 발생했습니다. 잠시 후 다시 확인해 주세요."),

    SUBSCRIPTION_NOT_FOUND(404, "SUBSCRIPTION_001", "구독 정보를 찾을 수 없습니다."),
    ...
    SUBSCRIPTION_REQUIRED(403, "SUBSCRIPTION_007", "AI 기능을 사용하려면 활성화된 구독권이 필요합니다."),
    SUBSCRIPTION_PAYMENT_INVALID(400, "SUBSCRIPTION_008", "구독 결제 정보가 올바르지 않습니다."),
